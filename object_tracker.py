...
flags.DEFINE_string('video', './data/video/MVI_9777.MOV',
...
def main(_argv):
    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            x1 = int(3 * height / 6 + height / 20)
            x2 = int(3 * height / 6 - height / 20)
            if x1 > bbox[1] > x2:
                ...
                cv2.putText(img, "Current Human Count: " + str(current_count), (0, 80), 0, 1, (0, 0, 255), 2)
                cv2.putText(img, "Total Human Count: " + str(total_count), (0, 130), 0, 1, (0, 0, 255), 2)

                center = (int(((bbox[0]) + (bbox[2])) / 2), int(((bbox[1]) + (bbox[3])) / 2))
                pts[track.track_id].append(center)

                cv2.line(img, (0, x1), (width, x1), (0, 255, 0), thickness=2)
                cv2.line(img, (0, x2), (width, x2), (0, 255, 0), thickness=2)
